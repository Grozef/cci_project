 ...
 */
final class Version20240114153238 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE asso_award (id INT AUTO_INCREMENT NOT NULL, id_award_id INT NOT NULL, id_book_id INT NOT NULL, UNIQUE INDEX UNIQ_FA01318F6D896E5A (id_award_id), UNIQUE INDEX UNIQ_FA01318FC83F1AF1 (id_book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE asso_cat (id INT AUTO_INCREMENT NOT NULL, id_book_id INT NOT NULL, id_category_id INT NOT NULL, UNIQUE INDEX UNIQ_C046AF47C83F1AF1 (id_book_id), UNIQUE INDEX UNIQ_C046AF47A545015 (id_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
...
/*        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', available_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', delivered_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_75EA56E0FB7336F0 (queue_name), INDEX IDX_75EA56E0E3BD61CE (available_at), INDEX IDX_75EA56E016BA31DB (delivered_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB'); */
        ...
        $this->addSql('ALTER TABLE user_info ADD CONSTRAINT FK_B1087D9E79F37AE5 FOREIGN KEY (id_user_id) REFERENCES `user` (id)');
    }
